...
export const products: Product[] = [
  // ── Business Platforms ──
  {
    ...
    description: "Build business applications, dashboards, and workflow systems using natural language — multi-tenant and multi-industry ready.",
  ...
  },
  {
    ...
    description: "Manage pipelines, automate invoicing, orchestrate workflows, and track revenue from one intelligent CRM.",
  ...
  },
  {
    ...
    description: "Resume screening, pipeline management, interview scheduling, and candidate tracking for modern recruitment teams.",
  ...
  // ── Industry Solutions ──
  {
    ...
    description: "Hospital management with patient lifecycle, appointments, prescriptions, billing, lab workflows, and multi-tenant isolation.",
  ...
  },
  {
    ...
    description: "Academic workflows, student progress tracking, study support, and institutional analytics for scalable education delivery.",
