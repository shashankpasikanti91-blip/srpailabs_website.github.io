          ...
          <motion.div initial="initial" animate="animate" variants={stagger}>
            <motion.div variants={fadeInUp}>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 border border-primary/20 text-primary text-sm font-medium mb-6">
                <span className="w-2 h-2 rounded-full bg-primary" /> Flexible Pricing
              </span>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-display mb-4">
                Pricing Per <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">Product</span>
              </h1>
              <p className="text-muted-foreground max-w-2xl mx-auto text-lg sm:text-xl mb-6">
                Each of our {PRODUCT_COUNT} products has its own pricing based on features, usage, and scale. Pay only for what you use.
              </p>
              <p className="text-sm text-muted-foreground/70 max-w-lg mx-auto">
                Visit any product below to see detailed pricing plans, free trials, and enterprise options.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-12 sm:py-16 bg-card/20 border-y border-border/40">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={fadeInUp} className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold font-display mb-4">Custom Automation Pricing</h2>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              For custom n8n workflows, AI agents, CRM builds, and multi-tenant SaaS projects — pricing is scoped per project based on complexity, integrations, and timeline.
            </p>
            <div className="grid sm:grid-cols-3 gap-4 mb-8 text-left">
              {[
                { tier: "Starter Automation", price: "From $299", desc: "Simple workflow automation — 1-3 nodes, basic integrations, delivered in 2-3 days." },
                { tier: "Business Automation", price: "From $999", desc: "Complex multi-step workflows with AI agents, CRM integration, and testing. 1-2 weeks." },
                { tier: "Enterprise Build", price: "Custom Quote", desc: "Full SaaS builds, multi-tenant platforms, and bespoke AI systems. Scoped per project." },
              ].map((tier, i) => (
